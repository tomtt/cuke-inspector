var cucumberStepCompletion = {
  ...
  displayMatchingStepsFor: function(cucumberStep) {
    jQuery('.cuke-inspector-step-browser-matching-steps').html(cucumberStepCompletion.matchingStepsToHtml(cucumberStep));
  },
  ...
  tableOfStepTemplates: function() {
    var html = "<table class='sorted cuke-inspector-step-definition-table'><thead><tr><th>Step definition</th><th>#&nbsp;&nbsp;&nbsp;</th></tr></thead>\n";
    html += "<tbody>\n";
    var items = jQuery.map(cucumberStepCompletion.stepTemplates(),
  ...
  createStepBrowser: function() {
    ...
    if(typeof(cucumberStepCompletion.cucumberSteps) != "undefined") {
      html = "<div class='cuke-inspector-step-browser-list'>";
    ...
    jQuery('.cuke-inspector-step-browser').html(html);
  }
}
